...
/// Create by zyf
/// Date: 2019/8/6
class ReposStarDbProvider extends BaseDbProvider {
  final String name = 'ReposStar';
  ...
  ReposStarDbProvider.fromMap(Map map) {
    id = map[columnId];
  ...
  Future _getProvider(Database db, String fullName) async {
    ...
    if (maps.length > 0) {
      ReposStarDbProvider provider = ReposStarDbProvider.fromMap(maps.first);
      return provider;
    }
    return null;
  }
